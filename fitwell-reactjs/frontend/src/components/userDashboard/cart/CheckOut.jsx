            ...
            <div class="container">
              <div class="column-two">
                <table class="details">
                  ...
                  <tr>
                    <td>Amount:</td>
                    <td><i class="fi-xnsuxm-rupee"></i><h5>
                      {/* Rs <%=amount%> */}
                      </h5> </td>
                  </tr>
                  <tr>
                    <td>Discount(5%):</td>
                    <td><i class="fi-xnsuxm-rupee"></i><h5>- Rs 
                  ...
                  <tr class="last">
                    ...
                    <td><i class="fi-xnsuxm-rupee"></i><h4>
                ...
                <table class="payment-method">
                  ...
                  <form method="post" action="/useractions/checkoutcart">
                    ...
                    <tr>
                      <td>
                        <button class="btn" type="submit" style={{height: '30px', backgroundColor: 'orange', fontSize: 'larger',paddingBottom: '40px'}}>Confirm Order</button>
                      </td>
                    </tr>
                  </form>
              </table>
